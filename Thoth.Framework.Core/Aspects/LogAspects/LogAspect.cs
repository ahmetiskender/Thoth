...
using Thoth.Framework.Core.CrossCuttingConcern.Logging;
using Thoth.Framework.Core.CrossCuttingConcern.Security.Web;
using log4net;
using PostSharp.Aspects;
using PostSharp.Extensibility;

namespace Thoth.Framework.Core.Aspects.LogAspects
{
    [Serializable]
