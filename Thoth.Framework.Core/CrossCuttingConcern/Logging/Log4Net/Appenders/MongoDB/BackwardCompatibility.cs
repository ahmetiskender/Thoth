...
namespace Thoth.Framework.Core.CrossCuttingConcern.Logging.Log4Net.Appenders.MongoDB
{
	public class BackwardCompatibility
	{
		public static MongoDatabase GetDatabase(MongoDbAppender appender)
		{
			...
			MongoServer connection = new MongoClient(mongoConnectionString.ToString()).GetServer();  // TODO Should be replaced with MongoClient, but this will change default for WriteConcern. See http://blog.mongodb.org/post/36666163412/introducing-mongoclient and http://docs.mongodb.org/manual/release-notes/drivers-write-concern
			connection.Connect();
