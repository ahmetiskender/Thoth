...
{
    [Serializable]
    [Table("thoth_media", Schema = "ydyazilim_thoth")]
    public class Media : IEntity
    {
	    ...
	    [Column("adress", TypeName = "nvarchar(MAX)")]
	    public string Adress { get; set; }

	    [Column("ref_mime_type_id", TypeName = "int")]
	    public int RefMimeTypeId { get; set; }
        ...
        [ForeignKey("RefMimeTypeId")]
        public virtual RefMimeTypes RefMimeTypesObject { get; set; }
