...
{
    [Serializable]
    [Table("thoth_building_class_beacons", Schema = "ydyazilim_thoth")]
    public class BuildingClassBeacons : IEntity
    {
        [Key]
	    [Column("id", TypeName = "int")]
	    public int Id { get; set; }

        [Column("beacon_id", TypeName = "int")]
        ...
        [ForeignKey("BeaconId")]
        public virtual Beacons BeaconsObject { get; set; }

        [ForeignKey("BuildingClassId")]
        public virtual BuildingClassBeacons BuildingClassBeaconsObject { get; set; }
