...
{
    [Serializable]
    [Table("thoth_building_classes", Schema = "ydyazilim_thoth")]
    public class BuildingClasses : IEntity
    {
        [Key]
	    ...
	    [Column("ref_floor_number_id", TypeName = "int")]
	    public int RefFloorNumberId { get; set; }
        ...
        public virtual Buildings BuildingsObject { get; set; }

        [ForeignKey("RefFloorNumberId")]
        public virtual RefFloorNumbers RefFloorNumbersObject { get; set; }
